...
#define RIBON_PARUS_RPH1_COMMAND_LINE_MAX_SIZE 4096u
...
#define RIBON_PARUS_RPH1_MAX_MODULES 8u
#define RIBON_PARUS_RPH1_MODULE_FLAG_INITIAL_IMAGE (1u << 0)
#define RIBON_PARUS_RPH1_MODULE_FLAG_ALL \
