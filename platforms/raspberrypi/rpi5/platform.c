...
static const struct RibonPlatformFacts selected_platform = {
    ...
    .diagnostic_uart_base = 0x107d001000ull,
    .diagnostic_poll_limit = 1000000u,
    .timer_frequency_hz = 54000000u,
    .native_input_capacity = 16ull * 1024ull * 1024ull,
    .payload_load_base = 0x00200000ull,
    .payload_load_size = 32ull * 1024ull * 1024ull,
};

/** @brief 선택된 physical-board platform fact를 반환한다. */
const struct RibonPlatformFacts *ribon_platform_selected(void) {
    return &selected_platform;
}

/** @brief 선택된 physical-board platform plugin descriptor다. */
const struct RibonPluginDescriptor ribon_platform_plugin_descriptor = {
    ...
    .arena_budget = 4096u,
    .input_budget = 16ull * 1024ull * 1024ull,
    .output_budget = 4096u,
    .deadline_ms = 30000u,
