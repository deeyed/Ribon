...
EXPECTED = {
    ...
    "qemu-riscv64-virt-linux": {
        "architecture": "riscv64",
        "environment": "raw-fdt",
        "port": "qemu-virt-riscv64",
        "map": "ribon.map",
        "product_id": "bootmgr.qemu-riscv64-virt-linux",
        "payload_entry_abi": "riscv64-linux-fdt-v1",
        "payload_format": "linux-riscv64-image",
        "boot_module_bundle": True,
        "needles": (
            "src/arch/riscv64/arch",
            "src/environments/raw-fdt/raw_fdt",
            "src/image-formats/linux_riscv64.o",
