...
GRAMMAR = PROJECT / "frontend" / "grammar" / "parser.gram"
TOKENS = PROJECT / "frontend" / "grammar" / "Tokens"
SNAPSHOTS = (
    PROJECT / "frontend" / "generated" / "parser.c",
    PROJECT / "frontend" / "generated" / "tokens.h",
)
RECEIPT = PROJECT / "frontend" / "generated" / "parser.receipt.json"
...
def main() -> int:
    ...
    for project_file in PROJECT.rglob("*"):
        if project_file.is_file() and project_file.suffix == ".ribos":
            print(
                f"legacy Ribos source extension: "
