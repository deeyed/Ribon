...
`ribos.gram`과 `Tokens`는 Ribos source syntax의 machine-readable 정본이다.
`docs/contracts/language/ribos-source-language.md`의 EBNF와 같은 변경에서
동기화한다.
...
Pegen C skeleton의 operation은 `language/src/ribos_parser_internal.h`가 제공하는
